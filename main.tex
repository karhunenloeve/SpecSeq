...
\begin{document}
    ...
    eine Umgebung $U \subset X$ mit $\widetilde{A}\subset \mathring{U}$ gibt und
    ...
    \begin{definition}[Faserung]
        ...
        \begin{itemize}[noitemsep]
            ...
            \item für jeden Lift $\widetilde{h}_{0} : Z \to X$ mit
                \[
    ...
    \begin{example}
        ...
        \begin{enumerate}[nolistsep]
            \item Seien $X,Y$ topologische Räume. Dann ist die Projektion
                ...
                \[
                    \widetilde{h}(z,t) \;=\; \Bigl( p_{X} \circ \widetilde{h}_{0} (
                    z),\; h(z,t)\Bigr),
                \]
