...
\begin{document}
    ...
    \begin{definition}[Homologische Sequenz]
        ...
        \begin{enumerate}[nolistsep]
            ...
            \item $E^{r+1}_{p,q}$ ist die zugehörige Homologie von $A^{r}$, das heißt
                \[
                    E^{r+1}_{p,q}\;=\; \frac{\ker \bigl(d^{r}_{p,q}\bigr)}{\mathrm{im}\,\bigl(d^{r}_{p+r,q-r+1}\bigr)}
                    .
                \]
        \end{enumerate}
    \end{definition}
    ...
    \begin{definition}
        ...
        \begin{itemize}[nolistsep]
            \item $\displaystyle \ker f \;\coloneqq\; \bigoplus_{p,q \in \Z}\ker \bigl(
                f_{p,q}\bigr)$,

            \item $\displaystyle \ima f \;\coloneqq\; \bigoplus_{p,q \in \Z}\ima \bigl(
                f_{p-c,q-d}\bigr)$.
        \end{itemize}
    \end{definition}

    Nun können wir die zuvor definierte homologische Sequenz (Definition \ref{homologischeSequenz})
    zu einer \textbf{spektralen} homologischen Sequenz erweitern.
        ...
        \begin{itemize}[nolistsep]
            ...
            \item $E^{r+1}$ ist die Homologie von $E^{r}$ bezüglich des Differentials $d
                ...
                \[
                    ...
                    \in \Z}\ker\bigl(d^{r}_{p,q}\bigr)}%
                    {\displaystyle\bigoplus_{p,q \in \Z} \mathrm{im}\!\bigl(d^r_{\,p-r,\,q+r-1}\bigr)}
                    \;=\; \bigoplus_{p,q \in \Z}\frac{\ker\bigl(d^{r}_{p,q}\bigr)}{\mathrm{im}\!\bigl(d^{r}_{\,p-r,\,q+r-1}\bigr)}
                    .
                \]
        \end{itemize}
    \end{definition}
    ...
    \begin{remark}
        ...
        Spektralsequenz}, die in analoger Weise zu Definition~\ref{homologischeSpektraleSequenz}
    ...
    Homologie
    \[
        H_{n}(X,A) \;\cong\; \tilde{H}_{n}\bigl(X/A\bigr)
    \]
    ...
    zu verwenden:
    \[
        \cdots \;\longrightarrow\; \tilde{H}_{n}(A) \;\longrightarrow\; \tilde{H}_{n}
        (X) \;\longrightarrow\; \tilde{H}_{n}\bigl(X/A\bigr) \;\longrightarrow\; \tilde
        {H}_{n-1}(A) \;\longrightarrow\; \tilde{H}_{n-1}(X) \;\longrightarrow\; \cdots
        .
    \]
    ...
    man eine solche \textbf{Matroschka} von topologischen Räumen als \textbf{Filtrierung}
    auffassen:
    ...
    \begin{lemma}
        ...
        \begin{itemize}[nolistsep]
            ...
            \item Für alle $i(a) \in A':\; j'\bigl(i(a)\bigr) \;=\; \bigl[j(a)\bigr] \;
                \in\; E'$,
    ...
    \begin{proof}
        ...
        \begin{enumerate}[nolistsep]
            \item \textbf{Wohldefiniertheit von $j'$.} \\ Sei $i(a_{1}) = i(a_{2})$
                ...
                \[
                    j(a_{1}) - j(a_{2}) \;=\; j(a_{1} - a_{2}) \;\in\; \ima(j\,k) \;=\; \ima
                    (d).
                \]
            ...
            \item \textbf{Wohldefiniertheit von $k'$.} \\ Für jedes
                ...
                Folglich gilt
                \[
                    k(e_{1} - e_{2}) = 0 \;\Longrightarrow\; k'\bigl([\,e_{1} - e_{2}\,]\bigr
                    ) = 0 \;\Longrightarrow\; k'\bigl([\,e_{1}\,]\bigr) = k'\bigl([\,e_{2}\,
                    ]\bigr).
                \]
            ...
            \item \textbf{Exaktheit des Diagramms.} \\ \textbf{(a)
                ...
                \[
                    (j' \circ i')(a') \;=\; j'\bigl(i'(a')\bigr) \;=\; j'\bigl(i\vert_{i(A)}
                    (a')\bigr).
                \]
                Da $a' = i(a)$, folgt
                \[
                ...
                Also
                \[
                    j'\bigl(i(a)\bigr) = \bigl[j(a)\bigr] = 0 \;\Longrightarrow\; j(a) \;\in
                    \; \ima(d).
                \]
                ...
                \[
                    a' \;=\; i(a) \;=\; i(a) \;-\; i(k(e)) \;=\; i\bigl(a - k(e)\bigr) \;=\;
                    i\bigl(i(b)\bigr) \;=\; i^{2}(b).
                \]
                ...
                \[
                    \bigl(k' \circ j'\bigr)(a') \;=\; k'\bigl(j'\bigl(i(a)\bigr)\bigr) \;=\;
                    k'\bigl([\,j(a)\bigr]) \;=\; k\bigl(j(a)\bigr).
                \]
                ...
                \[
                    (i' \circ k')\bigl([e]\bigr) \;=\; i'\bigl(k'( [e] )\bigr) \;=\; i\bigl
                ...
                = k'\bigl([e]\bigr)$. Also $\ker(i') \subset \ima(k')$.
    ...
    \begin{definition}[Exakte Paare einer Filtrierung]
        ...
        \[
            \begin{tikzcd}
                [cramped] \cdots & H_{p+q}(X_{p-1}) & H_{p+q}(X_{p}) & H_{p+q}(X_{p},X_{p-1})
                \\ & {} & \cdots & H_{p+q-1}(X_{p-1}) \arrow["{k^1_{p,q+1}}", from=1-1,
                to=1-2] \arrow["{i^1_{p,q}}", from=1-2, to=1-3] \arrow["{j^1_{p,q}}", from=1-3,
                to=1-4] \arrow["{k^1_{p,q}}", from=1-4, to=2-4] \arrow["{i^1_{p,q-1}}"',
                from=2-4, to=2-3]
            \end{tikzcd}
        \]
        Dabei gilt:
    ...
    Aus Definition~\ref{exaktFiltration} erhalten wir für jedes $r$ ein
    ...
    \begin{proof}
        ...
        \[
            ...
            \bigl(X_{p-1},\,X_{p-2}\bigr) \;=\; E^{1}_{p-1,\,q},
        \]
        ...
        \begin{enumerate}[nolistsep]
            \item $A^{r}_{p,q}= i^{r-1}\bigl(A^{1}_{p,q}\bigr)$.
        ...
        $\,A^{r}_{p,q}= i^{r-1}\bigl(A^{1}_{p,q}\bigr)$. Folglich
        \begin{align}
            j^{r}(a)  & \;=\; j^{r}\bigl(i^{r-1}(b)\bigr) \;=\; \bigl[j^{r-1}\bigl(i^{r-2}(b)\bigr)\bigr]                                           \\
            \nonumber & \;= \bigl[\bigl[j^{r-2}\bigl(i^{r-3}(b)\bigr)\bigr]\bigr] \;=\; \cdots \;=\; \bigl[\cdots \bigl[j^{1}(b)\bigr]\cdots\bigr].
        \end{align}
    ...
    \begin{example}
        ...
        \begin{enumerate}[nolistsep]
            \item Seien $X,Y$ topologische Räume. Dann ist die Projektion
                ...
                \[
                    \overline{h}(z,t) \;=\; \Bigl(\bigl(p_{X} \circ \overline{h}_{0}\bigr)(
                    z),\; h(z,t)\Bigr),
                \]
    ...
    betrachten und
    \[
        X_{p} \;\coloneqq\; \pi^{-1}\bigl(B^{p}\bigr)
    \]
    ...
    \[
        E^{1}_{p,q}\;\coloneqq\; H_{p+q}\bigl(X_{p},\,X_{p-1};\,G\bigr).
    \]
    ...
    \begin{theorem}
        ...
        \begin{enumerate}[label=(\alph{*})]
            ...
            \item $E^{r+1}_{p,q}$ ist die Homologie von $E^{r}_{\bullet,\bullet}$ an der
                ...
                \[
                    E^{r+1}_{p,q}\;=\; \frac{\ker\bigl(d^{r} : E^{r}_{p,q}\to E^{r}_{\!*}\bigr)}{\mathrm{im}\bigl(d^{r}
                    : E^{r}_{\!*}\to E^{r}_{p,q}\bigr)}.
                \]

            \item Auf der zweiten Seite gilt
                \[
                    E^{2}_{p,q}\;\cong\; H_{p}\bigl(B;\,H_{q}(F;G)\bigr).
                \]
    ...
    \[
        \phi \colon \mathbb{R}^{2n+2}\to \mathbb{C}^{n+1}, \quad (x_{1}, \dots, x_{2n+2}
        ) \mapsto \bigl(x_{1} + i x_{2},\, x_{3} + i x_{4},\, \dots,\, x_{2n+1}+ i x_{2n+2}
        \bigr)
    \]
    ...
    \[
        C_{2k}\bigl(\mathbb{C}P^{\infty}\bigr) \;\cong\; H_{2k}\bigl(X_{2k},\,X_{2k-1}
        \bigr) \;\cong\; \mathbb{Z}\quad \text{für }k \geq 0,
    \]
    sowie
    \[
        C_{k}\bigl(\mathbb{C}P^{\infty}\bigr) \;\cong\; H_{k}\bigl(X_{k},\,X_{k-1}\bigr
    ...
    Es gilt:
    \[
        H_{k}\bigl(\mathbb{C}P^{\infty}\bigr) \;=\;
        \begin{cases}
    ...
    \[
        E^{2}_{p,q}= H_{p}\bigl(\mathbb{C}P^{\infty}\bigr) \otimes H_{q}\bigl(S^{1}\bigr
        ).
    \]
    ...
    \[
        E^{2}_{p,q}= H_{p}\bigl(B;\, H_{q}(F;\mathbb{Z})\bigr)
    \]
    gegeben.
    ...
    \[
        H_{p}\bigl(B;\, H_{q}(S^{1};\mathbb{Z})\bigr) = H_{p}(B;0) = 0.
    \]
    ...
    \[
        E^{2}_{p,q}= H_{p}\bigl(B; H_{q}(F;\mathbb{Z})\bigr) = H_{p}(B;\mathbb{Z}) =
        H_{p}(B) = H_{p}\bigl(\mathbb{C}P^{\infty}\bigr).
    \]
